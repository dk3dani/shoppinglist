class ListsController < ApplicationController
  ...
  def destroy
    @list.destroy
    respond_to do |format|
      format.html { redirect_to user_lists_url, notice: 'Contact was successfully destroyed.' }
  ...
  private
    ...
    def list_params
      params.require(:list).permit(:name, :description ,:purchase, products_attributes: [:id, :name, :_destroy])
